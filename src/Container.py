...
from src.app.usecases.turn.get_available_colors import GetAvailableColors
from src.app.usecases.turn.get_number_beads import GetBeadsPerCombination
from src.app.usecases.turn.get_previous_proposals import GetPreviousProposals
