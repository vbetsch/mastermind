...
class SessionController(IController):
    ...
    @check_data_is_defined(EventEnum.CALLBACK_PREPARE, PlayerPresenter)
    @check_data_required_fields(EventEnum.CALLBACK_PREPARE, PlayerPresenter)
    def _handle_create_and_run_session(self, message: str, sender: Subscriber, data: PlayerPresenter = None) -> None:
